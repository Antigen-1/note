...
◊p{owe原意为欠。例如◊b{IOU欠条}、◊b{-How much do I owe you?(付款时用) -It's on the house.店家请客}、◊b{You owe him an apology/explanation你欠他一个道歉/解释}}
...
◊h2{convertible&conversion&convert}

◊p{convertible [n]1.可兑换证券 2.敞篷汽车 [adj]可改变的}

◊p{conversion [n]1. 改变，转变。the conversion of ... into ...:...到...的转变}

◊p{◊i{the conversion of a barn into a house}畜棚变住宅}

◊p{conversion [n]2. 改变信仰，皈依。one's conversion from ... to ...:由...到...的信仰转变}

◊p{convert [v]1. 改变（形式或用途）[T/I] convert (sth) to/into sth}

◊p{◊i{They converted the spare bedroom into an office}他们将空闲的卧室转变为了一间办公室}

◊p{convert [v]2. 改变信仰[T/I] convert (sb) to sth}
