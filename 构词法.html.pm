...
dl
anthropoid@类人的
anthropogenic@人类导致/产生的
philanthropist@慈善家@phil=love
}

重要词根（o）logy=to study

◊lst{
dl
physiology@生理学
archaeology@考古学@archaic：古雅的
}
...
◊b{Yandi and Huangdi are the legendary ancestors of the Chinese nation.}
...
◊lst{
ul
preserve：保护，保存（处于良好状态）
conserve：保护（数量不减少）
reserve：保留（未来使用）/预订（～ n for 基数词）
}
